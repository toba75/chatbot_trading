...
- Risques: livrer les benchmarks sans traçabilité; oublier d'enrôler M-012 dans `scripts/test.ps1` et `scripts/lint.ps1`; produire un rapport d'écarts non actionnable pour M-013.
...
- Dépendances: T-011; `docs/traceability/matrix.md`; `scripts/test.ps1`; `scripts/lint.ps1`; `scripts/validate_definition_of_done.ps1`. M-013 consomme le rapport d'écarts V1 produit par M-012, mais n'est pas une dépendance d'implémentation de T-012.
- Commandes de validation: `powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\m012\validate_m012_traceability_acceptance.ps1`; `powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\m012\validate_m012_traceability_unit.ps1`; `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\validate_m012_traceability.ps1`; `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\validate_traceability.ps1`; `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\test.ps1`; `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\lint.ps1`.
