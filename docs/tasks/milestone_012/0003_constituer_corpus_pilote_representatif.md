...
- Tests d'acceptation à écrire: `uv run --locked gate`, qui échoue si le manifeste contient moins de 50 ou plus de 100 PDF, si une strate normative manque, si un document n'a pas d'identifiant stable ou si un chemin non résolvable est accepté.
