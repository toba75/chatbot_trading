...
- Tests d'acceptation à écrire: `uv run --locked gate`, couvrant création depuis version publiée, refus source en quarantaine, idempotence, absence de mutation SP et contrat HTTP `POST /v1/documents/{document_id}/index`.
