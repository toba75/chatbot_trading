...
- Tests d'acceptation à écrire: `tests/m006/validate_claim_relation_acceptance.ps1`, couvrant contradiction comparable, contradiction apparente et généralisation.
