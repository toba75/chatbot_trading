...
- Tests d'acceptation à écrire: `uv run --locked gate`, couvrant extraction, vérification, lecture de claim, lecture de preuves `EvidenceRef` avec `SourceLocator` résolvable et erreurs publiques.
