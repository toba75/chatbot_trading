...
- Tests d'acceptation à écrire: `tests/m007/validate_evidence_set_sealing_acceptance.ps1`, qui échoue tant que RA ne scelle pas un jeu de preuves versionné à partir des ports KA et EG.
