...
| T-010 - Interdire les couplages intercontextes | `1acee47` | `dff4da5` | DDD-ADR-001; ADR-011 | Aucune | `tests/m001/validate_architecture_boundaries_acceptance.ps1`; `tests/m001/validate_architecture_boundaries_unit.ps1`; `scripts/validate_architecture_boundaries.ps1`; `scripts/test.ps1`; `scripts/lint.ps1` |
