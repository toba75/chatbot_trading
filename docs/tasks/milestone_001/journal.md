...
| T-010 - Interdire les couplages intercontextes | `1acee47` | `dff4da5` | DDD-ADR-001 | Aucune | `tests/m001/validate_architecture_boundaries_acceptance.ps1`; `tests/m001/validate_architecture_boundaries_unit.ps1`; `scripts/validate_architecture_boundaries.ps1`; `scripts/test.ps1`; `scripts/lint.ps1` |
| T-011 - Relier M-001 à la traçabilité et aux gates | `d5c6fdd` | Commit de clôture T-011 | ADR-010; DDD-ADR-001; DDD-ADR-002; DDD-ADR-003; DDD-ADR-005; DDD-ADR-006; DDD-ADR-007; DDD-ADR-008; DDD-ADR-009 | Aucune | `tests/m001/validate_m001_traceability_acceptance.ps1`; `tests/m001/validate_m001_traceability_unit.ps1`; `scripts/validate_traceability.ps1`; `scripts/validate_definition_of_done.ps1`; `scripts/test.ps1`; `scripts/lint.ps1` |
