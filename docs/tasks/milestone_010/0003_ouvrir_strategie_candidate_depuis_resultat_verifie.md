...
- Tests d'acceptation à écrire: `tests/m010/validate_strategy_candidate_creation_acceptance.ps1`, qui échoue tant qu'une stratégie ne conserve pas mandat, origine RA, claims et diagnostics de traduction, ou tant qu'une commande SD avec version attendue obsolète peut modifier la stratégie.
