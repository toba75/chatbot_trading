...
- Métriques de clôture: `versions_canoniques_publiees`, `pages_refusees_qa` et `autorites_textuelles_ambiguës` sont agrégées par `scope=m004` depuis des événements d'audit sans contenu documentaire complet.
