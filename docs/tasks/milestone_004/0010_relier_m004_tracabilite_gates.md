...
- Implémentation attendue: mettre à jour `docs/traceability/matrix.md`, compléter les validateurs ou l'agrégateur de gates si nécessaire, vérifier les métriques `versions_canoniques_publiees`, `pages_refusees_qa`, `autorites_textuelles_ambiguës` et documenter la clôture dans `docs/tasks/milestone_004/journal.md`.
