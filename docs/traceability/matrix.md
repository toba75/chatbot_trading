...
| REQ-M000-006 | docs/specs/plan_implementation_milestones_workstreams.md | Planifié | docs/tasks/milestone_000/0005_definir_achevement_transverse_verifiable.md | Non applicable: T-005 n'est pas encore exécutée. | docs/tasks/milestone_000/0005_definir_achevement_transverse_verifiable.md | Non requise | Aucune décision structurante nouvelle: la définition d'achèvement reste à implémenter dans T-005. |
| REQ-M000-007 | docs/specs/plan_implementation_milestones_workstreams.md | Planifié | docs/tasks/milestone_000/0006_assembler_commandes_validation_initiales.md | Non applicable: T-006 n'est pas encore exécutée. | docs/tasks/milestone_000/0006_assembler_commandes_validation_initiales.md | Non requise | Aucune décision structurante nouvelle: les commandes globales restent à assembler dans T-006. |
