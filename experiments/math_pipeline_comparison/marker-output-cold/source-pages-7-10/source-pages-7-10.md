...
<sup>1</sup>In this book, if a term is **in bold**, that means that this term can be found in the index at the end of the book.
...
- $\mathbf{wx}_i - b \geq 1$  if  $y_i = +1$ , and
   $\mathbf{wx}_i - b < -1$  if  $y_i = -1$
