...
|---|---|---:|---:|---:|
| image_only | p1_feature_indices | 4 | 4 | 5.796 |
| image_only | p2_hyperplane | 1 | 1 | 0.591 |
| image_only | p2_sign_and_negative | 2 | 2 | 2.35 |
| image_only | p2_model | 1 | 1 | 1.154 |
| image_only | p2_constraints | 1 | 1 | 2.957 |
| image_plus_source | p1_feature_indices | 4 | 4 | 6.111 |
| image_plus_source | p2_hyperplane | 1 | 1 | 0.553 |
| image_plus_source | p2_sign_and_negative | 2 | 2 | 2.332 |
| image_plus_source | p2_model | 1 | 1 | 1.153 |
| image_plus_source | p2_constraints | 1 | 1 | 2.855 |
