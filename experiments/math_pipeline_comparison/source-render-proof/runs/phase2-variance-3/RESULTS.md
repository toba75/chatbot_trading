...
|---|---|---:|---:|---:|
| image_only | p1_feature_indices | 4 | 4 | 5.808 |
| image_only | p2_hyperplane | 1 | 1 | 0.705 |
| image_only | p2_sign_and_negative | 2 | 2 | 2.343 |
| image_only | p2_model | 1 | 1 | 1.143 |
| image_only | p2_constraints | 1 | 1 | 2.971 |
| image_plus_source | p1_feature_indices | 4 | 4 | 6.117 |
| image_plus_source | p2_hyperplane | 1 | 1 | 0.55 |
| image_plus_source | p2_sign_and_negative | 2 | 2 | 2.334 |
| image_plus_source | p2_model | 1 | 1 | 1.129 |
| image_plus_source | p2_constraints | 1 | 1 | 2.889 |
