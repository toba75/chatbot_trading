...
$expectedBehaviors = @(
    ...
    @{ Name = "V1-006 - Sauvegarde chiffrée et restauration testée"; Test = "T-007"; Adr = @("ADR-009", "DDD-ADR-010"); Command = "powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\m013\validate_backup_restore_acceptance.ps1" },
