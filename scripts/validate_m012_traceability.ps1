...
Assert-Condition -Condition ($lintGateContent.Contains('-ExpectedValidationCount 24')) -Message "Compteur lint M-012 incohérent"
Assert-Condition -Condition ($governanceTestContent.Contains('$expectedTestCount = 270')) -Message "Compteur test global M-012 incohérent"
...
Assert-Condition -Condition ($governanceTestContent.Contains('Gate test GREEN: 23 validation(s)')) -Message "Compteur validation test M-012 incohérent"
Assert-Condition -Condition ($governanceTestContent.Contains('Gate lint GREEN: 24 validation(s), 0 test(s).')) -Message "Compteur validation lint M-012 incohérent"
