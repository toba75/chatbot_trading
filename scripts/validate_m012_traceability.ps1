...
Assert-Condition -Condition ($lintGateContent.Contains('-ExpectedValidationCount 29')) -Message "Compteur lint M-012 incohérent"
...
Assert-Condition -Condition ($governanceTestContent.Contains('Gate lint GREEN: 29 validation(s), 0 test(s).')) -Message "Compteur validation lint M-012 incohérent"
