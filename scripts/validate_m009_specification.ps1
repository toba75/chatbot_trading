...
$expectedBehaviors = @(
    ...
    @{ Name = "DRA-004 - Claims et dépendances EG indépendantes"; Adr = @("ADR-006", "DDD-ADR-005", "DDD-ADR-008"); Test = "T-005"; Command = "powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\m009\validate_verified_claim_dependency_resolution_acceptance.ps1" },
    @{ Name = "DRA-005 - Contradictions conditionnelles"; Adr = @("DDD-ADR-005", "DDD-ADR-007"); Test = "T-006"; Command = "powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\m009\validate_deep_contradiction_classification_acceptance.ps1" },
