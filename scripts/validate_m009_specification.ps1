...
$expectedBehaviors = @(
    ...
    @{ Name = "DRA-003 - Collecte multi-requêtes diversifiée"; Adr = @("ADR-006", "DDD-ADR-003", "DDD-ADR-005"); Test = "T-004"; Command = "powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\m009\validate_deep_research_evidence_collection_acceptance.ps1" },
