...
$requiredM007Requirements = @(
    ...
    [ordered] @{
        Id = "REQ-M007-003"
        Source = "docs/tasks/milestone_007/0003_ouvrir_cas_recherche_mandat_explicite.md"
        Test = "tests/m007/validate_research_case_mandate_acceptance.ps1"
        CommandScript = "tests/m007/validate_research_case_mandate_acceptance.ps1"
        Code = "app/research_answering/domain/research_case.py; app/research_answering/application/open_research_case.py; app/research_answering/domain/research_planning.py; app/research_answering/adapters/in_memory_research_case_repository.py"
        Adr = "ADR-010"
    }
    [ordered] @{
        Id = "REQ-M007-004"
        Source = "docs/tasks/milestone_007/0004_sceller_jeu_preuves_reponse.md"
        Test = "tests/m007/validate_evidence_set_sealing_acceptance.ps1"
        CommandScript = "tests/m007/validate_evidence_set_sealing_acceptance.ps1"
        Code = "app/research_answering/domain/evidence_set.py; app/research_answering/application/collect_evidence.py"
        Adr = "DDD-ADR-003; DDD-ADR-008"
    }
    [ordered] @{
        Id = "REQ-M007-005"
        Source = "docs/tasks/milestone_007/0005_classer_contradictions_lacunes.md"
        Test = "tests/m007/validate_contradiction_gap_acceptance.ps1"
        CommandScript = "tests/m007/validate_contradiction_gap_acceptance.ps1"
        Code = "app/research_answering/domain/contradiction_assessment.py; app/research_answering/application/classify_contradictions.py; app/research_answering/domain/research_case.py"
        Adr = "DDD-ADR-005"
    }
    [ordered] @{
        Id = "REQ-M007-006"
        Source = "docs/tasks/milestone_007/0006_extraire_assertions_reponse.md"
        Test = "tests/m007/validate_answer_assertion_extraction_acceptance.ps1"
        CommandScript = "tests/m007/validate_answer_assertion_extraction_acceptance.ps1"
        Code = "app/research_answering/domain/answer.py; app/research_answering/application/draft_answer.py; app/research_answering/adapters/local_answer_assertion_extractor.py"
        Adr = "DDD-ADR-005; DDD-ADR-007"
    }
    [ordered] @{
        Id = "REQ-M007-007"
        Source = "docs/tasks/milestone_007/0007_evaluer_support_citations_reponse.md"
        Test = "tests/m007/validate_answer_support_acceptance.ps1"
        CommandScript = "tests/m007/validate_answer_support_acceptance.ps1"
        Code = "app/research_answering/domain/answer.py; app/research_answering/application/verify_answer.py"
        Adr = "ADR-006; DDD-ADR-003; DDD-ADR-005; DDD-ADR-007"
    }
    [ordered] @{
        Id = "REQ-M007-008"
        Source = "docs/tasks/milestone_007/0008_declencher_abstention_donnees_actuelles.md"
        Test = "tests/m007/validate_current_data_abstention_acceptance.ps1"
        CommandScript = "tests/m007/validate_current_data_abstention_acceptance.ps1"
        Code = "app/research_answering/domain/answer.py; app/research_answering/application/verify_answer.py"
        Adr = "DDD-ADR-007"
    }
    [ordered] @{
        Id = "REQ-M007-009"
        Source = "docs/tasks/milestone_007/0009_exposer_commande_reponse_documentaire.md"
        Test = "tests/m007/validate_answer_http_contract_acceptance.ps1"
        CommandScript = "tests/m007/validate_answer_http_contract_acceptance.ps1"
        Code = "app/research_answering/adapters/answer_http.py; app/research_answering/application/answer_question.py"
        Adr = "ADR-010; DDD-ADR-003; DDD-ADR-005"
    }
    [ordered] @{
        Id = "REQ-M007-010"
        Source = "docs/tasks/milestone_007/0010_relier_m007_metriques_tracabilite_gates.md"
        Test = "tests/m007/validate_m007_traceability_acceptance.ps1"
        CommandScript = "tests/m007/validate_m007_traceability_acceptance.ps1"
        Code = "app/research_answering/application/traceability_metrics.py"
...
$requiredM009Requirements = @(
    [ordered] @{
        Id = "REQ-M009-001"
        Source = "docs/tasks/milestone_009/0001_verifier_precondition_green.md"
...
$requiredM013Requirements = @(
    ...
    [ordered] @{
        Id = "REQ-M013-FASTAPI-001"
        Source = "docs/tasks/milestone_013-fastapi/0001_verifier_precondition_green.md"
        Test = "tests/m013_fastapi/validate_precondition_acceptance.ps1; tests/m013_fastapi/validate_precondition_unit.ps1"
        CommandScript = "tests/m013_fastapi/validate_precondition_acceptance.ps1"
        Code = "docs/governance/m013_fastapi_precondition.md; docs/tasks/milestone_013-fastapi/journal.md"
        Adr = "ADR-018"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-002"
        Source = "docs/tasks/milestone_013-fastapi/0002_decider_frontiere_http_publique.md"
        Test = "tests/m013_fastapi/validate_fastapi_specification_acceptance.ps1; tests/m013_fastapi/validate_fastapi_architecture_policy_unit.ps1"
        CommandScript = "scripts/validate_m013_fastapi_specification.ps1"
        Code = "docs/specs/m013_fastapi_api_orchestratrice.md; docs/adr/ADR-019-api-orchestratrice-fastapi-uvicorn.md; scripts/validate_m013_fastapi_specification.ps1"
        Adr = "ADR-018; ADR-019; DDD-ADR-001"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-003"
        Source = "docs/tasks/milestone_013-fastapi/0003_servir_sante_api_application_construite.md"
        Test = "tests/m013_fastapi/validate_orchestrator_asgi_health_acceptance.ps1; tests/m013_fastapi/validate_orchestrator_app_factory_unit.ps1"
        CommandScript = "tests/m013_fastapi/validate_orchestrator_asgi_health_acceptance.ps1"
        Code = "app/platform/orchestrator_asgi.py; app/platform/orchestrator_composition.py; app/platform/orchestrator_runtime.py"
        Adr = "ADR-019; ADR-021"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-004"
        Source = "docs/tasks/milestone_013-fastapi/0004_preserver_contrats_api_existants.md"
        Test = "tests/m013_fastapi/validate_existing_api_contract_parity_acceptance.ps1; tests/m013_fastapi/validate_existing_api_routers_unit.ps1"
        CommandScript = "tests/m013_fastapi/validate_existing_api_contract_parity_acceptance.ps1"
        Code = "app/platform/orchestrator_contract_routers.py; app/platform/orchestrator_public_services.py; app/platform/orchestrator_asgi.py"
        Adr = "ADR-019"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-005"
        Source = "docs/tasks/milestone_013-fastapi/0005_partager_etat_documentaire_durable.md"
        Test = "tests/m013_fastapi/validate_document_persistence_restart_acceptance.ps1; tests/m013_fastapi/validate_document_persistence_unit.ps1; tests/m013_fastapi/validate_review3_deployment_live.ps1"
        CommandScript = "tests/m013_fastapi/validate_review3_deployment_live.ps1"
        Code = "app/source_processing/adapters/postgres_document_persistence.py; app/platform/orchestrator_runtime.py; deploy/postgres/migrations/001_document_persistence.sql; deploy/postgres/migrations/005_source_processing_read_performance.sql; deploy/postgres/migrations/008_claim_fencing_and_projection_replay.sql; deploy/local-compose/application.compose.yaml; deploy/local-compose/compose.yaml"
        Adr = "ADR-021; ADR-023; ADR-024; ADR-025; ADR-026"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-006"
        Source = "docs/tasks/milestone_013-fastapi/0006_enregistrer_pdf_lancer_diagnostic.md"
    ...
    [ordered] @{
        ...
        Source = "docs/tasks/milestone_013-fastapi/0007_lire_diagnostic_conversion.md"
    ...
    [ordered] @{
        ...
        Source = "docs/tasks/milestone_013-fastapi/0008_recuperer_pdf_original_controle.md"
        Test = "tests/m013_fastapi/validate_original_pdf_retrieval_acceptance.ps1; tests/m013_fastapi/validate_original_pdf_stream_unit.ps1"
        CommandScript = "tests/m013_fastapi/validate_original_pdf_retrieval_acceptance.ps1"
        Code = "app/source_processing/application/original_queries.py; app/source_processing/adapters/original_http.py; app/source_processing/adapters/postgres_document_persistence.py"
        Adr = "ADR-018; ADR-020; ADR-021"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-009"
        Source = "docs/tasks/milestone_013-fastapi/0009_lire_projection_connaissance.md"
        Test = "tests/m013_fastapi/validate_ka_projection_persistence_unit.ps1; tests/m013_fastapi/validate_ka_projection_persistence_live.ps1"
        CommandScript = "tests/m013_fastapi/validate_ka_projection_persistence_live.ps1"
        Code = "app/knowledge_access/adapters/postgres_projection_read.py; deploy/postgres/migrations/004_knowledge_projection_chunk_samples.sql; docs/tasks/milestone_013-fastapi/journal.md"
        Adr = "ADR-021; ADR-022; DDD-ADR-004"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-010"
        Source = "docs/tasks/milestone_013-fastapi/0010_brancher_ui_api_orchestratrice.md"
        Test = "tests/m013_fastapi/validate_ui_product_contracts_unit.ps1; tests/m013_fastapi/validate_ui_orchestrator_document_flow_acceptance.ps1"
        CommandScript = "tests/m013_fastapi/validate_ui_orchestrator_document_flow_acceptance.ps1"
        Code = "app/contracts/document_public_statuses.py; app/platform/ui_document_api.py; app/platform/ui_corpus.py; app/platform/local_runtime.py; docs/specs/ui.md; docs/tasks/milestone_013-fastapi/journal.md"
        Adr = "ADR-018; ADR-021"
    },
    [ordered] @{
        Id = "REQ-M013-FASTAPI-011"
        Source = "docs/tasks/milestone_013-fastapi/0011_deployer_auditer_api_orchestratrice.md"
        Test = "tests/m013_fastapi/validate_review_governance_performance_acceptance.ps1; tests/m013_fastapi/validate_reproducible_operations_acceptance.ps1; tests/m013_fastapi/validate_orchestrator_deployment_acceptance.ps1; tests/m013_fastapi/validate_review3_deployment_acceptance.ps1; tests/m013_fastapi/validate_review3_deployment_live.ps1; tests/m013_fastapi/validate_postgres_migration_upgrade_live.ps1; tests/m013_fastapi/validate_document_http_live_acceptance.ps1; tests/m013_fastapi/validate_document_worker_live.ps1; tests/m013_fastapi/validate_job_outbox_boundary_acceptance.ps1; tests/m013_fastapi/validate_job_outbox_boundary_live.ps1; tests/m013_fastapi/validate_ka_projection_persistence_live.ps1; tests/m013_fastapi/validate_review3_safety_acceptance.ps1; tests/m013_fastapi/validate_review3_safety_live.ps1; tests/m013_fastapi/validate_m013_fastapi_traceability_unit.ps1"
        CommandScript = "scripts/validate_m013_fastapi.ps1"
        Code = ".dockerignore; pyproject.toml; uv.lock; app/platform/orchestrator_command.py; app/platform/orchestrator_runtime.py; app/platform/orchestrator_asgi.py; app/platform/orchestrator_contract_routers.py; app/platform/orchestrator_public_services.py; app/platform/orchestrator_api_models.py; app/platform/postgres_migrations.py; app/platform/job_runtime/relay.py; app/platform/job_runtime/postgres.py; app/source_processing/adapters/http.py; app/source_processing/adapters/original_http.py; app/source_processing/adapters/postgres_document_persistence.py; app/source_processing/adapters/postgres_job_outbox.py; app/source_processing/adapters/worker_runtime.py; app/source_processing/adapters/pdf_inspection_process.py; app/knowledge_access/adapters/postgres_projection_read.py; deploy/postgres/migrations/007_job_outbox_context_boundary.sql; deploy/postgres/migrations/008_claim_fencing_and_projection_replay.sql; deploy/local-compose/application.compose.yaml; deploy/local-compose/Caddyfile; deploy/local-compose/compose.yaml; deploy/local-compose/Dockerfile; scripts/validate_m013_fastapi.ps1; docs/runbooks/api_orchestratrice.md; docs/governance/m013_fastapi_audit.md; docs/tasks/milestone_013-fastapi/journal.md"
        Adr = "ADR-018; ADR-019; ADR-020; ADR-021; ADR-023; ADR-024; ADR-025; ADR-026"
    }
)
...
function Assert-CommandCell {
    ...
    $commandPattern = "^powershell\s+-NoProfile\s+-ExecutionPolicy\s+Bypass\s+-File\s+(?<script>\.?[\\/][^\s;|&]+)(?:\s+-Path\s+(?<pathArg>\.?[\\/][^\s;|&]+))?(?:\s+-Mode\s+(?:Static|Live))?\s*$"
...
function Assert-M009PathCell {
    ...
    Assert-Condition `
        -Condition ($actualValue -eq $ExpectedValue) `
        -Message "$CellName M-009 invalide pour ${RequirementId}. Attendu: $ExpectedValue. Obtenu: $actualValue"
}
...
function Assert-M009RequirementRows {
    param(
        [Parameter(Mandatory = $true)]
        [object[]] $Rows
    )

    $milestoneDir = Join-Path $repoRoot "docs/tasks/milestone_009"
    if (-not (Test-Path -LiteralPath $milestoneDir -PathType Container)) {
        return
    }
    ...
    $currentMatrixPath = [System.IO.Path]::GetFullPath($matrixPath)
    if (-not $currentMatrixPath.Equals($canonicalMatrixPath, [System.StringComparison]::OrdinalIgnoreCase)) {
        $containsM009Rows = @($Rows | Where-Object {
            (Get-MatrixRowCell -Row $_ -CellName "Exigence" -RequirementId "ligne inconnue") -match "^REQ-M009-"
        }).Count -gt 0
        if (-not $containsM009Rows) {
            Assert-Condition `
                -Condition $AllowM000OnlyMatrix `
                -Message "Matrice M-009 absente sans autorisation explicite."
            return
        }
    }
    ...
    foreach ($expected in $requiredM009Requirements) {
        $requirementId = $expected["Id"]

        Assert-Condition `
            -Condition ($rowsByRequirementId.ContainsKey($requirementId)) `
            -Message "Exigence M-009 livrée absente: $requirementId"
        ...
        Assert-Condition `
            -Condition ($status -eq "Couvert") `
            -Message "Exigence M-009 livrée non couverte: $requirementId"
        ...
        Assert-Condition `
            -Condition ($commandScript -eq $expected["CommandScript"]) `
            -Message "Commande M-009 invalide pour ${requirementId}. Attendu: $($expected["CommandScript"]). Obtenu: $commandScript"

        $adr = Get-MatrixRowCell -Row $row -CellName "ADR" -RequirementId $requirementId
        Assert-Condition `
            -Condition ($adr -eq $expected["Adr"]) `
            -Message "ADR M-009 invalide pour ${requirementId}. Attendu: $($expected["Adr"]). Obtenu: $adr"

        $justification = Get-MatrixRowCell -Row $row -CellName "Justification ADR" -RequirementId $requirementId
        Assert-Condition `
            -Condition ($justification -match "^Décision structurante documentée:") `
            -Message "Justification ADR M-009 invalide pour ${requirementId}: $justification"
    }
}
