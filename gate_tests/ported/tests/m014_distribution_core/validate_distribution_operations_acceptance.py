...
POSTGRES_DIGEST = (
    "postgres@sha256:"
    "7e5df973a74872482e320dcbdeb055e178d6f42de0558b083892c50cda833c96"
)
...
def test_distribution_locale_exploitable_reproductible_et_tracable() -> None:
    ...
    assert f'POSTGRES_IMAGE = "{POSTGRES_DIGEST}"' in live_support
    assert "from gate_tests.live_support import POSTGRES_IMAGE" in quota_live
    ...
    assert "la capacité Granite globale doit être le produit" not in configuration_source
