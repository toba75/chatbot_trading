...
def _assert_prochaine_adr_est_054() -> None:
    """Given ADR-053 présente, When l'index réserve le suivant, Then il annonce ADR-054."""
    ...
    assert "ADR-053-migrations-m014-expand-contract-rejeu.md" in index
    assert "Prochaine ADR technique: ADR-054" in index
