...
try {
    ...
    $m010BranchRoot = New-TemporaryProject -Name "m010-branch" -TestGateContent $greenTestGate -LintGateContent $greenLintGate -IncludeMilestone003 $true
    ...
    Assert-OutputContains -Output $m010BranchResult.Output -Expected "Branche M-004 autorisée" -Message "La sortie doit annoncer une branche M-004 autorisée."
