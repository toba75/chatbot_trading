...
try {
    ...
    Assert-OutputContains -Output $lintResult.Output -Expected "Gate lint GREEN: 29 validation(s), 0 test(s)." -Message "La gate de lint doit prouver le nombre exact de validations et tests."
