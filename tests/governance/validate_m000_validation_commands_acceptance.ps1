...
try {
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Gate test GREEN: 14 validation(s), 104 test(s)." -Message "La gate de test doit prouver le nombre exact de validations et tests."
