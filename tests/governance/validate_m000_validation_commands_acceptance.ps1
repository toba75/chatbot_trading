...
elseif ($env:OST_M013_PRECONDITION_ACCEPTANCE_RUNNING -eq "1") {
    $expectedTestCount = 267
}
$expectedTestSummary = "Gate test GREEN: 27 validation(s), $expectedTestCount test(s)."
...
try {
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Validation GREEN: scripts/validate_network_boundary.ps1" -Message "La gate de test doit exécuter le validateur de frontière réseau M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_network_boundary_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation frontière réseau M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_network_boundary_unit.ps1" -Message "La gate de test doit exécuter le test unitaire frontière réseau M-002."
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_outbox_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation outbox M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_outbox_unit.ps1" -Message "La gate de test doit exécuter le test unitaire outbox M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_job_runtime_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation file de jobs M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_job_runtime_unit.ps1" -Message "La gate de test doit exécuter le test unitaire file de jobs M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_gateway_observability_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation observabilité gateway M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_gateway_observability_unit.ps1" -Message "La gate de test doit exécuter le test unitaire observabilité gateway M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_m002_traceability_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de traçabilité M-002."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m002/validate_m002_traceability_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de traçabilité M-002."
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Validation GREEN: scripts/validate_m005_specification.ps1" -Message "La gate de test doit exécuter le validateur de spécification M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_m005_specification_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de spécification M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_m005_specification_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de spécification M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Validation GREEN: scripts/validate_m006_specification.ps1" -Message "La gate de test doit exécuter le validateur de spécification M-006."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m006/validate_m006_specification_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de spécification M-006."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m006/validate_m006_specification_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de spécification M-006."
    Assert-OutputContains -Output $testResult.Output -Expected "Validation GREEN: scripts/validate_m007_specification.ps1" -Message "La gate de test doit exécuter le validateur de spécification M-007."
    Assert-OutputContains -Output $testResult.Output -Expected "Validation GREEN: scripts/validate_m008_specification.ps1" -Message "La gate de test doit exécuter le validateur de spécification M-008."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_projection_metadata_filters_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation des filtres de projection M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_projection_metadata_filters_unit.ps1" -Message "La gate de test doit exécuter le test unitaire des filtres de projection M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_projection_encoding_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation d'encodage de projection M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_projection_encoding_unit.ps1" -Message "La gate de test doit exécuter le test unitaire d'encodage de projection M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_qdrant_projection_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation d'index Qdrant M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_qdrant_projection_unit.ps1" -Message "La gate de test doit exécuter le test unitaire d'index Qdrant M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_knowledge_projection_events_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation des événements de projection M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_hybrid_search_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de recherche hybride M-005."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m005/validate_hybrid_search_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de recherche hybride M-005."
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m006/validate_m006_precondition_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de précondition M-006."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m006/validate_m006_precondition_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de précondition M-006."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m007/validate_m007_precondition_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de précondition M-007."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m007/validate_m007_precondition_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de précondition M-007."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m007/validate_m007_specification_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de spécification M-007."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m007/validate_m007_specification_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de spécification M-007."
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m004/validate_canonical_publication_event_unit.ps1" -Message "La gate de test doit exécuter le test unitaire d'événement CanonicalSourcePublished M-004."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m004/validate_document_conversion_command_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de commande de conversion M-004."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m004/validate_document_conversion_command_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de commande de conversion M-004."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m004/validate_m004_traceability_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de traçabilité M-004."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m004/validate_m004_traceability_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de traçabilité M-004."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m009/validate_m009_precondition_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de précondition M-009."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m009/validate_m009_precondition_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de précondition M-009."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m010/validate_m010_precondition_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de précondition M-010."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m010/validate_m010_precondition_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation de précondition M-010."
    Assert-OutputContains -Output $testResult.Output -Expected "Validation GREEN: scripts/validate_m009_specification.ps1" -Message "La gate de test doit exécuter le validateur de spécification M-009."
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m012/validate_m012_specification_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de spécification M-012."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m012/validate_pilot_corpus_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation du corpus M-012."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m012/validate_page_annotation_set_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation des annotations M-012."
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m012/validate_document_route_benchmark_acceptance.ps1" -Message "La gate de test doit exécuter le test d'acceptation des routes documentaires M-012."
    ...
    Assert-OutputContains -Output $testResult.Output -Expected "Test GREEN: tests/m009/validate_multi_query_evidence_collection_unit.ps1" -Message "La gate de test doit exécuter le test unitaire de collecte multi-requêtes M-009."
    ...
    Assert-OutputContains -Output $lintResult.Output -Expected "Gate lint GREEN: 28 validation(s), 0 test(s)." -Message "La gate de lint doit prouver le nombre exact de validations et tests."
    ...
    Assert-OutputContains -Output $lintResult.Output -Expected "Validation GREEN: scripts/validate_m005_specification.ps1" -Message "La gate de lint doit exécuter le validateur de spécification M-005."
    Assert-OutputContains -Output $lintResult.Output -Expected "Validation GREEN: scripts/validate_m006_specification.ps1" -Message "La gate de lint doit exécuter le validateur de spécification M-006."
    Assert-OutputContains -Output $lintResult.Output -Expected "Validation GREEN: scripts/validate_m007_specification.ps1" -Message "La gate de lint doit exécuter le validateur de spécification M-007."
    Assert-OutputContains -Output $lintResult.Output -Expected "Validation GREEN: scripts/validate_m008_specification.ps1" -Message "La gate de lint doit exécuter le validateur de spécification M-008."
    Assert-OutputContains -Output $lintResult.Output -Expected "Validation GREEN: scripts/validate_m009_specification.ps1" -Message "La gate de lint doit exécuter le validateur de spécification M-009."
    Assert-OutputContains -Output $lintResult.Output -Expected "Validation GREEN: scripts/validate_m010_specification.ps1" -Message "La gate de lint doit exécuter le validateur de spécification M-010."
    ...
    Assert-OutputContains `
        ...
        -Expected "scripts/validate_traceability.ps1" `
    ...
    Assert-OutputContains `
        ...
        -Expected "Le rapport doit prouver le volume de tests courant" `
        -Message "La gate amputée doit conserver un refus explicite du volume de tests."
}
finally {
