...
try {
    ...
    $m006BranchRoot = New-TemporaryProject -Name "m006-branch" -TestGateContent $greenTestGate -LintGateContent $greenLintGate -IncludeM004Artifacts $true
    Initialize-ProjectWithMasterAndBranch -ProjectRoot $m006BranchRoot -BranchName $postMergeBranch -DivergeMasterReference $false
    ...
    Assert-OutputContains -Output $m006BranchResult.Output -Expected "Branche M-005 autorisée: $postMergeBranch" -Message "La branche M-006 autorisée doit être nommée."

    $m007BranchRoot = New-TemporaryProject -Name "m007-branch" -TestGateContent $greenTestGate -LintGateContent $greenLintGate -IncludeM004Artifacts $true
    ...
    $m009BranchRoot = New-TemporaryProject -Name "m009-branch" -TestGateContent $greenTestGate -LintGateContent $greenLintGate -IncludeM004Artifacts $true
    ...
    Assert-OutputContains -Output $m009BranchResult.Output -Expected "Branche M-005 autorisée: $postMergeM009Branch" -Message "La branche M-009 autorisée doit être nommée."

    $m010BranchRoot = New-TemporaryProject -Name "m010-branch" -TestGateContent $greenTestGate -LintGateContent $greenLintGate -IncludeM004Artifacts $true
    ...
    Assert-OutputContains -Output $m010BranchResult.Output -Expected "Branche M-005 autorisée" -Message "La sortie doit annoncer une branche M-005 autorisée."
