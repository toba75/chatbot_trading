...
try {
    ...
    Assert-OutputContains `
        ...
        -Expected "Branche courante invalide. Autorisées: master, $expectedBranch, $postMergeBranch, $postMergeM007Branch, $postMergeM008Branch, $postMergeM009Branch. Obtenu: $invalidBranch" `
